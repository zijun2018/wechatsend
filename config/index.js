...
module.exports ={
  ...
  NAME:'D。菇凉',//备注姓名
  NICKNAME:'一勺言', //昵称
  MEMORIAL_DAY:'2019/02/06', //你和收信者的纪念日
  CITY:'jiangxi',//收信者所在城市
  LOCATION:'nanchang',//收信者所在区 （可以访问墨迹天气网站后，查询区的英文拼写）
  SENDDATE:'0 15 8 * * *',//定时发送时间 每天8点0分0秒发送，规则见 /schedule/index.js
  ...
  APIKEY:'68380244b8384c2ebbb2f417fbf810ba',//图灵机器人apikey
